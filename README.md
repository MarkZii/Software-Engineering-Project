This repository contains a desktop implementation of the KenKen math and logic puzzle game.

Developed in Java and featuring an intuitive GUI built with JavaFX, the application provides a complete environment to assist users during gameplay.

Key Features:
* Custom Gameplay: Play and create custom puzzle configurations with grid sizes ranging from $3\times3$ to $9\times9$.
